...
import EventCard from "@/components/pages/projectspage/EventCard";
...
interface FocusClientPageProps {
	...
	projectYears: string[];
	currentProjectYear: string;
	currentProjectPage: number;
	hasMoreProjects: boolean;
	events: ContentItem[];
}

export default function FocusClientPage({
	projects,
	projectYears,
	currentProjectYear,
	currentProjectPage,
	...
	useEffect(() => {
		...
		const sections = ["projects", "events"];
		sections.forEach((id) => {
			const element = document.getElementById(id);
		...
		<div className="min-h-screen bg-background">
			...
			<section className="relative h-[40vh] min-h-[400px] flex items-center justify-center bg-chemonics-navy text-white overflow-hidden">
				...
				<div className="container relative z-20 text-center px-4">
					...
					>
						Driving impact through strategic initiatives and community
						engagement.
					</motion.p>
				</div>
			</section>
