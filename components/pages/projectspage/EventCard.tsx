...
export default function EventCard({ event }: EventCardProps) {
	// Determine if it's training based on title or tags (simulated logic for now)
	// In a real app we might want a separate 'category' field,
	// but for now let's assume if it says "Training" in title it's training.
